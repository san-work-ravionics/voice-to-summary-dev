...
# phase2-checklist's summarize.py for why (a small local model was unreliable at judging
...
# This matters more here than in phase2-checklist: the assistant explicitly names any
