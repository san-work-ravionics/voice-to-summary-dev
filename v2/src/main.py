...
def run_pipeline(regenerate=False, provider=None, judge_provider=None, on_stage=None):
    ...
    if judge_provider is not None:
        ...
        append_run("v2", "baseline", provider, judge_provider, transcript, baseline, evaluation)
    ...
    if judge_provider is not None:
        ...
        append_run("v2", "with_context", provider, judge_provider, transcript, with_context, evaluation)
